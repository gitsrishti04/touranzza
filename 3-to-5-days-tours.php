...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    ...
    <meta name="description" content="Discover India's treasures in 3-5 days with our curated short tours. Perfect for busy travelers seeking luxury experiences of the Golden Triangle and Rajasthan heritage." />
    <!-- fonts -->
        ...
        <section class="page-header">
            ...
            <div class="container">
                <h2 class="page-header__title wow animated fadeInLeft" data-wow-delay="0s" data-wow-duration="1500ms">
                    3 to 5 Days Journey</h2>
                <div class="page-header__breadcrumb-box">
                    <ul class="trevlo-breadcrumb">
                        <li><a href="./">Home</a></li>
                        <li>3 to 5 Days Journey</li>
                            ...
                            <div class="tour-listing__card-content">
                                <div class="tour-listing__card-camera-group">
                                    <a href="javascript:void(0);"
                                        class="tour-listing__card-camera-btn trevlo-image-popup" data-gallery-options='{"items": [{"src": "assets/images/tours/agrai-tour-1.webp"}, {"src": "assets/images/tours/delhi-tour-1.webp"}, {"src": "assets/images/tours/jaipur-tour-1.webp"}, {"src": "assets/images/tours/gt8.webp"}], "gallery": {"enabled": true}, "type": "image"}'>
