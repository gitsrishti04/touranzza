  ...
  <section class="tour-listing-details tour-listing-details-right">
    <div class="tour-listing-details__top-carousel">
      <div class="tour-listing-details__top-carousel-wrapper trevlo-owl__carousel owl-theme owl-carousel" data-owl-options='{
        ...
        <!-- /.tour-listing-details__top-carousel-item item -->
        <div class="tour-listing-details__top-carousel-item item">
          <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/amritsar1.jpg" alt="listing-details-carousel">
            <div class="tour-listing-details__top-carousel-overlay"> <a href="#" class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup" data-gallery-options='{
                        "items": [
                          {
                            "src": "assets/images/tours/amritsar1.jpg"
                          },
                          {
                            "src": "assets/images/tours/amritsar1.jpg"
                          }
        ...
        <!-- /.tour-listing-details__top-carousel-item item -->
        <div class="tour-listing-details__top-carousel-item item">
          <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/amritsar2.jpg" alt="listing-details-carousel">
            <div class="tour-listing-details__top-carousel-overlay"> <a href="#" class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup" data-gallery-options='{
                        "items": [
                          {
                            "src": "assets/images/tours/amritsar2.jpg"
                          },
                          {
                            "src": "assets/images/tours/amritsar2.jpg"
                          }
        ...
        <div class="tour-listing-details__destination-row row">
          <div class="col-xl-6 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
            <div class="tour-listing-details__destination-left">
              <h1 class="tour-listing-details__dastination-title">Golden Triangle Tour With Amritsar</h1>
            ...
            <div class="tour-listing-details__destination-right">
              ...
              <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.7s" data-wow-duration="1500ms"> <span class="icon-location-1"></span>
                <div class="tour-listing-details__destination-info-title">
                  ...
                  <h4 class="tour-listing-details__destination-info-bottom">Delhi - Agra - Jaipur - Amritsar - Delhi</h4>
                </div>
              </div>
              <!-- /.tour-listing-details__destination-info -->
            </div>
            ...
            <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
              <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content">
                  <div class="inner">
                    <p>First Day Of Golden Triangle Tour With Amritsar. You Will Be Welcomed And Pick Up By Our Company Representative On Arrival At Delhi Airport. And Then You Will Be Transferred To Hotel. Overnight Stay In Delhi Hotel.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>After Breakfast, Scenic Drive Towards Agra, Upon Arrival Check Into Hotel And Post Lunch. Start Sightseeing Of Agra, Visit Beautiful Agra Fort, Overnight Stay At Agra Hotel.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>Pick Up From Hotel At 06:30 A.M., Leave To Visit Taj Mahal At Sunrise Time Then Come Back To Hotel For Having Healthy Breakfast. Check Out From Hotel. And Visit Mehtab Bagh And Beautiful Itmad - Ud - Daulah (Baby Taj). Leave To Jaipur Via Fatehpur Sikri And Post Lunch. Overnight Stay At Jaipur Hotel.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
              ...
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>After Breakfast, Drive Towards Delhi, Upon Arrival, Check Into Hotel. Overnight Stay At Delhi Hotel.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                <div class="accrodion-title">
                  <h4><span>Day 7</span> Delhi - Amritsar (By Train)</h4>
                </div>
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>Early Morning Transfer To Delhi Railway Station To Catch Train For Amritsar, Arrive Amritsar In The Afternoon, Pick Up From Amritsar Railway By Our Executive And Transfer To The Hotel, Start Sightseeing Tour Of Amritsar Visit Wagha Border, In The Evening Enjoy Dinner In Local Restaurant Or In Hotel. Overnight Stay At Hotel In Amritsar.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                <div class="accrodion-title">
                  <h4><span>Day 8</span> Amritsar - Delhi (By Train)</h4>
                </div>
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>After Breakfast, Start Sightseeing Tour Amritsar, Visit Golden Temple And Jallianwala Bagh, In The Afternoon Transfer To Amritsar Railway Station To Catch Train For Delhi, Pick Up From Delhi Railway Station By Our Executive, Transfer To Hotel, Overnight Stay At Hotel In Delhi.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                <div class="accrodion-title">
                  <h4><span>Day 9</span> Delhi</h4>
                </div>
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>Transfer To Delhi Airport As Per Your Flight Schedule To Board Flight For Onward Destination With Sweet Memories Of Delhi Agra Jaipur Amritsar Tour.</p>
                  </div>
                </div>
              </div>
              <!-- <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
