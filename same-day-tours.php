...
<section class="page-header">
    ...
    <!-- /.page-header__bg -->
    <div class="container">
        <h2 class="page-header__title wow animated fadeInLeft" data-wow-delay="0s" data-wow-duration="1500ms">Same Day Tours</h2>
...
<section class="tour-listing-one tour-listing section-space">
            <div class="container">
                    ...
                    <div class="col-xl-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                        <div class="tour-listing__card">
                            <a href="same-day-agra-tour-by-car.php" class="tour-listing__card-image-box">
                                <img src="assets/images/tours/agrai-tour-2.jpg" alt="assets/images/tours/tour-3-1.jpg" class="tour-listing__card-image">
                                <div class="tour-listing__card-btn-group">

                                    <div class="tour-listing__card-discount @@innerExtraClassName">SD</div>
                ...
                "type": "image"
                                ...
                                <h3 class="tour-listing__card-title"><a href="same-day-agra-tour-by-car.php">Same Day Agra Tour By Car</a></h3>
                                ...
                                <div class="tour-listing__card-inner-content">
                                    ...
                                    <div class="tour-listing__card-location-box">
                                        ...
                                        <p class="tour-listing__card-location-text text-small"> DELHI - AGRA - DELHI</p>
                                    ...
                                    <div class="tour-listing__card-bottom">
                                        <div class="tour-listing__card-bottom-left">
                                            <div class="tour-listing__card-day">
                                                ...
                                                <p class="tour-listing__card-day-text text-small"> 01 DAY TRIP</p>
                    ...
                    <div class="col-xl-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">
                        <div class="tour-listing__card">
                            <a href="same-day-agra-tour-by-train.php" class="tour-listing__card-image-box">
                                <img src="assets/images/tours/agrai-tour-1.jpg" alt="assets/images/tours/tour-3-2.jpg" class="tour-listing__card-image">
                                <div class="tour-listing__card-btn-group">
                ...
                "type": "image"
                                ...
                                <h3 class="tour-listing__card-title"><a href="same-day-agra-tour-by-train.php">Same Day Agra Tour By Train</a></h3>
                                <p class="tour-listing__card-text text-small">There are many variations of passages of Lorem Ipsum agtilable</p>
                                <div class="tour-listing__card-inner-content">
                                    <div class="tour-listing__card-review-box">
                                        <span class="icon-star"></span>
                    ...
                    <div class="col-xl-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.5s" data-wow-duration="1500ms">
                        <div class="tour-listing__card">
                            <a href="same-day-agra-tour-by-gatimaan-express.php" class="tour-listing__card-image-box">
                                <img src="assets/images/tours/same-day-tour.jpg" alt="assets/images/tours/tour-3-3.jpg" class="tour-listing__card-image">
                                <div class="tour-listing__card-btn-group">
                ...
                "type": "image"
                                ...
                                <h3 class="tour-listing__card-title"><a href="same-day-agra-tour-by-gatimaan-express.php">Same Day Agra Tour By Gatimaan Express</a></h3>
                                <p class="tour-listing__card-text text-small">There are many variations of passages of Lorem Ipsum agtilable</p>
                                <div class="tour-listing__card-inner-content">
                                    <div class="tour-listing__card-review-box">
                                        <span class="icon-star"></span>
                    ...
                    <div class="col-xl-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                        <div class="tour-listing__card">
                            <a href="taj-mahal-sunrise-tour.php" class="tour-listing__card-image-box">
                                <img src="assets/images/tours/sunrise-tour.jpg" alt="assets/images/tours/tour-3-4.jpg" class="tour-listing__card-image">
                                <div class="tour-listing__card-btn-group">
                ...
                "type": "image"
                                ...
                                <h3 class="tour-listing__card-title"><a href="taj-mahal-sunrise-tour.php">Taj Mahal Sunrise Tour</a></h3>
                                <p class="tour-listing__card-text text-small">There are many variations of passages of Lorem Ipsum agtilable</p>
                                <div class="tour-listing__card-inner-content">
                                    <div class="tour-listing__card-review-box">
                                        <span class="icon-star"></span>
                    ...
                    <div class="col-xl-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                        <div class="tour-listing__card">
                            <a href="same-day-delhi-tour.php" class="tour-listing__card-image-box">
                                <img src="assets/images/tours/delhi-tour-3.jpg" alt="assets/images/tours/tour-3-4.jpg" class="tour-listing__card-image">
                                <div class="tour-listing__card-btn-group">
                ...
                "type": "image"
                                ...
                                <h3 class="tour-listing__card-title"><a href="same-day-delhi-tour.php">Same Day Delhi Tour</a></h3>
                                <p class="tour-listing__card-text text-small">There are many variations of passages of Lorem Ipsum agtilable</p>
                                <div class="tour-listing__card-inner-content">
                                    <div class="tour-listing__card-review-box">
                                        <span class="icon-star"></span>
                                    ...
                                    <div class="tour-listing__card-location-box">
                                        <span class="icon-location-1"></span>
                                        <p class="tour-listing__card-location-text text-small"> DELHI</p>
                                    </div><!-- /.tour-listing__card-location-box -->
                                    <div class="tour-listing__card-divider"></div><!-- /.tour-listing__card-divider -->
                                    <div class="tour-listing__card-bottom">
                                        <div class="tour-listing__card-bottom-left">
                ...
                "type": "image"
                                ...
                                <h3 class="tour-listing__card-title"><a href="same-day-jaipur-tour.php">Same Day Jaipur Tour</a></h3>
                                <p class="tour-listing__card-text text-small">There are many variations of passages of Lorem Ipsum agtilable</p>
                                <div class="tour-listing__card-inner-content">
                                    <div class="tour-listing__card-review-box">
                                        <span class="icon-star"></span>
                                    ...
                                    <div class="tour-listing__card-location-box">
                                        <span class="icon-location-1"></span>
                                        <p class="tour-listing__card-location-text text-small"> DELHI - JAIPUR - DELHI</p>
                                    </div><!-- /.tour-listing__card-location-box -->
                                    <div class="tour-listing__card-divider"></div><!-- /.tour-listing__card-divider -->
                                    <div class="tour-listing__card-bottom">
                                        <div class="tour-listing__card-bottom-left">
