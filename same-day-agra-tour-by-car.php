...
<!-- TOUR HIGHLIGHTS -->
            ...
            <div class="tour-listing-details__overview">
              ...
              <ul class="tour-listing-details__overview-text wow animated fadeInUp list-unstyled" data-wow-delay="0.3s" data-wow-duration="1500ms">
                <li style="margin-bottom: 8px;"><i class="fas fa-arrow-right" style="color:var(--trevlo-base); margin-right: 8px;"></i> Prefer a faster option? Try our <a href="taj-mahal-day-tour-by-train" style="color: inherit; text-decoration: underline; font-weight: 600;">Taj Mahal tour by train</a>.</li>
                <li style="margin-bottom: 8px;"><i class="fas fa-arrow-right" style="color:var(--trevlo-base); margin-right: 8px;"></i> For photographers, our <a href="taj-mahal-sunrise-tour" style="color: inherit; text-decoration: underline; font-weight: 600;">sunrise Taj Mahal tour from Delhi</a> is ideal.</li>
                <li style="margin-bottom: 8px;"><i class="fas fa-arrow-right" style="color:var(--trevlo-base); margin-right: 8px;"></i> Explore more <a href="taj-mahal-tour-packages" style="color: inherit; text-decoration: underline; font-weight: 600;">Agra tour packages here</a>.</li>
              </ul>
            </div>
