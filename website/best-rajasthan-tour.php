    ...
    <section class="tour-listing-details tour-listing-details-right">
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/delhitour2.jpg"
              ...
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  ...
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour2.jpg"}, {"src": "assets/images/tours/udaipur-tour1.jpg"}, {"src": "assets/images/tours/ranakpur1.jpg"}, {"src": "assets/images/tours/jaisalmer-2.jpg"}, {"src": "assets/images/tours/bikaner-2.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/jaisalmer-2.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour2.jpg"}, {"src": "assets/images/tours/udaipur-tour1.jpg"}, {"src": "assets/images/tours/ranakpur1.jpg"}, {"src": "assets/images/tours/jaisalmer-2.jpg"}, {"src": "assets/images/tours/bikaner-2.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <div class="tour-listing-details__destination-row row">
            <div class="col-xl-6 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
              <div class="tour-listing-details__destination-left">
                <h1 class="tour-listing-details__dastination-title">Best Royal Rajasthan Retreats</h1>
              ...
              <div class="tour-listing-details__destination-right">
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.1s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">13 Days</h4>
                  </div>
                </div>
                ...
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.7s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">DELHI - UDAIPUR - RANAKPUR - JODHPUR -
                      JAISALMER - BIKANER - JAIPUR - AGRA - DELHI</h4>
                  </div>
                </div>
                <!-- /.tour-listing-details__destination-info -->
              </div>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p>Meet on arrival at Delhi Airport by our representative and transfer to your pre-booked hotel.
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast full day city tour of Old and New Delhi, visit Shanti Vana (the cremation sites
                        of Jawaharlal Nehru, Raj Ghat (the cremation sites of Mahatma Gandhi), Jama Masjid and drive
                        past Red Fort and Chandni Chowk. In the afternoon visit India Gate (War Memorial Arch), Qutub
                        Minar (built by Qutub-ud-Din Aibek in 1199), Humayun's Tomb) and drive past President's House,
                        Parliament House, Connaught Place shopping centre and Akshardham temple (a modern Hindu Temple).
                        Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 3</span> Delhi - Udaipur (By Flight)</h4>
                  </div>
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast transfer to Delhi Airport for Udaipur. Meet on arrival at Udaipur airport by
                        our representative and transfer to hotel. Evening free for shopping around the local market.
                        Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 4</span> Udaipur</h4>
                  </div>
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast full day city tour of Udaipur, visit City Palace, Saheliyon ki Bari (Gardens of
                        the maids of Honor), Museum and Jagdish Temple. In the evening take a boat ride at Lake Pichola.
                        Later transfer to your hotel. Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 5</span> Udaipur - Ranakpur - Jodhpur</h4>
                  </div>
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Jodhpur. Enroute visit Ranakpur. Ranakpur is 98 Kms from Udaipur, the
                        Jain Temples built in the 15th century are situated in the lovely valley of the Aravali. Its
                        surrounding is quiet and picturesque. Ranakpur has grand structures and beautiful sculpture.
                        There are 1444 pillars in the temple and none of them are similar. The magic of light & shade is
                        really awe inspiring. Surya Temple and other Jain Temples are side attractions. Later continue
                        drive to Jodhpur. On arrival at Jodhpur check-in at hotel. Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 6</span> Jodhpur - Jaisalmer</h4>
                  </div>
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast city tour of Jodhpur, visit Mehrangarh Fort, the Jaswant Thada and the Umaid
                        Bhawan Palace. Afternoon drive to Jaisalmer. On arrival at Jaisalmer check-in at hotel.
                        Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  <div class="accrodion-title">
                    <h4><span>Day 7</span> Jaisalmer</h4>
                  </div>
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast full day city tour of Jaisalmer, visit the Jaisalmer Fort, Havelis, Manak
                        Chowk, Gadisar Lake, also visit painted & colorful market. In the afternoon go for an excursion
                        to Sam Sand Dunes (40 kms from Jaisalmer city). In the evening take camel safari at desert and
                        enjoy the sun set. Later drive back to Jaisalmer and transfer to your hotel. Overnight stay at
                        hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Bikaner. On arrival at Bikaner check-in at hotel. Rest of the day free
                        to explore the local area. Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast local tour of Bikaner, visit Bikaner Fort, the Lalgarh Palace and the Deshnoke
                        Temple. Afternoon drive to Jaipur. On arrival at Jaipur check-in at hotel. Overnight stay at
                        hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>In the morning visit the Amber Fort ascend fort in open Jeep. Amber was the ancient capital of
                        Kachwaha dynasty for long time ago. It was moved to newly created Jaipur. Visit the Sheesh Mahal
                        (Hall of victory) which is a hall glittering with mirrors. Afternoon visit Maharaja's City
                        Palace, the Observatory and drive past to Hawa Mahal. Evening transfer to hotel or free for
                        shopping in the local market. Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Agra. En route stop at Fatehpur Sikri. Fatehpur Sikri was built by
                        Akbar, the Mughal emperor between 1571 and 1585. It is one of the finest examples of Mughal
                        architectural splendour. It was constructed mainly as a tribute to the great Sufi saint Shaikh
                        Salim Chishti who had blessed Akbar with a son. Though the city is in ruins, it is a must visit
                        place for those who visit Agra. On arrival at Agra our representative will assist in your check
                        in process at the hotel. Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Morning visit the famous Taj Mahal in sunrise, built by Mughal Emperor Shah Jahan in memory of
                        his wife Mumtaz Mahal. This monument is made of white marble and it took 22 years to get
                        constructed. After breakfast visit the Agra Fort which has the Pearl Mosque, Diwan-e-am (the
                        hall of public audience) and Diwan-e-Khas (the hall of private audience). Later drive back to
                        Delhi. On arrival at Delhi our representative will assist in your check in process at the hotel.
                        Overnight stay at hotel.</p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-xl-4">
            <aside class="tour-listing-details__sidebar">
              <div
                ...
                <form action="tourmail.php" class="tour-listing-details__sidebar-form">
                  ...
                  <div class="tour-listing-details__sidebar-form-input">
                    ...
                    <input id="phone" name="phone" type="tel" class="form-one__input">
                  ...
                  <div class="tour-listing-details__sidebar-form-input">
                    ...
                    <select class="selectpicker" name="adults" id="adults" aria-label="Adults">
                  ...
                  <div class="tour-listing-details__sidebar-form-input">
                    ...
                    <select class="selectpicker" name="child" id="child" aria-label="Children">
                  ...
                  <div class="tour-listing-details__sidebar-form-input">
                    ...
                    <input name="hiddenField" type="hidden" id="hiddenField" value="Best Royal Rajasthan Retreats">
                  </div>
