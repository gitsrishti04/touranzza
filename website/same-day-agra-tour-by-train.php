      ...
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/agra-4.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/agra-4.jpg"}, {"src": "assets/images/tours/agra-3.jpg"}, {"src": "assets/images/tours/agra-2.jpg"}, {"src": "assets/images/tours/agratour1.jpg"}, {"src": "assets/images/tours/agra-1.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/agratour1.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/agra-4.jpg"}, {"src": "assets/images/tours/agra-3.jpg"}, {"src": "assets/images/tours/agra-2.jpg"}, {"src": "assets/images/tours/agratour1.jpg"}, {"src": "assets/images/tours/agra-1.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p>You will be picked up in the morning at 05:00 AM from your hotel and will be transferred to New
                        Delhi Railway Station. Our staff will be there to make you board on the train to the Mughal city
                        “Agra”. Must carry your identity proof at the time of your train journey!</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Shatabdi train will depart at 06:00 AM from New Delhi railway station and will reach in Agra
                        around 08:15 AM. Enjoy your morning breakfast on your seat. Our staff/tour guide will be pick up
                        you railway station Agra directly drive to Taj Mahal if you want for refreshment our drive will
                        be stop at good hotel for fresh –n-up few minute after enjoy the Symbol of Love Taj Mahal Tour.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Positioned smartly on the bank of the Yamuna River, TajMahal was a perfect combination of
                        Indian and Mughal arts. The monument was built by Mughal Emperor Shah Jahan to give a tribute to
                        his lovely wife Mumtaj and now it is a symbol of love and integrity. The monument is also a part
                        of the honeymoon trip for lovers and couples. Besides its amazing beauty, you can find a number
                        of attractive things. The surroundings of it provide you a pleasing atmosphere where you can
                        feel the true love of Shah Jahan for his beautiful wife. Enjoy some time here while relaxing in
                        the gardens and just see the monument. It is spread in huge area and has beautifully decorated
                        gardens. Discover all around the monuments together with your loved one and get familiar with
                        its history.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>It is often assumed as the Sister Monument of Taj. The fort is a massive place to see and know
                        about its interesting past of here. It was built with the red sandstone and looks splendid. The
                        monument was once a residence of Mughal and now it has been opened for the public to visit.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Agra is also well-known for its delicious cuisines. Visit a good restaurant to take pleasure in
                        a delicious lunch. Spend some time in leisure and continue your trip to enjoy your day.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>A duplicate copy of the TajMahal, the Baby Taj is well-known for its ancient value and a great
                        structural design. Itmad-Ud-Daula was a respected title and used to give to the most important
                        person of the state and it was an honor for MirzaGhiyas Beg. After his death, the Mughal emperor
                        constructed a monument to give honor to Mirza and this memorial is known as Itmad-Ud-Daula Tomb.
                        If you get some time in hand, discover more attractions in the local streets of the city -
                        Jewelry Museum and Marble Factory.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Afterward, back to the Agra Railway Station and catch the train to return back to Delhi. Dinner
                        will be offered on the train. On arrival, our staff will make you drop at your desired location.
                        Same Day Agra Tour by Shatabdi Train completes here with a happy note. You will have
                        unforgettable memories to share and cherish throughout the year. The tour package can be
                        modernized as per your choice and need. You can also add more destinations in this package to
                        travel more attractions and add more interesting things in your memory lists to enjoy your
                        travel interests more than ever.</p>
                    </div>
                  </div>
                </div>
                <!-- <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
