    ...
    <section class="tour-listing-details tour-listing-details-right">
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/delhitour1.jpg"
              ...
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  ...
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour1.jpg"}, {"src": "assets/images/tours/jaipur-tours1.jpg"}, {"src": "assets/images/tours/ajmer.jpg"}, {"src": "assets/images/tours/pushkar.jpg"}, {"src": "assets/images/tours/mount-abu.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/ajmer.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour1.jpg"}, {"src": "assets/images/tours/jaipur-tours1.jpg"}, {"src": "assets/images/tours/ajmer.jpg"}, {"src": "assets/images/tours/pushkar.jpg"}, {"src": "assets/images/tours/mount-abu.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/pushkar.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour1.jpg"}, {"src": "assets/images/tours/jaipur-tours1.jpg"}, {"src": "assets/images/tours/ajmer.jpg"}, {"src": "assets/images/tours/pushkar.jpg"}, {"src": "assets/images/tours/mount-abu.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/mount-abu.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour1.jpg"}, {"src": "assets/images/tours/jaipur-tours1.jpg"}, {"src": "assets/images/tours/ajmer.jpg"}, {"src": "assets/images/tours/pushkar.jpg"}, {"src": "assets/images/tours/mount-abu.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              ...
              <div class="tour-listing-details__destination-right">
                ...
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.7s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">DELHI - JAIPUR - AJMER - PUSHKAR - UDAIPUR
                      - MOUNT ABU - JODHPUR - UDAIPUR</h4>
                  </div>
                </div>
                <!-- /.tour-listing-details__destination-info -->
              </div>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p>Pick Up From Delhi Airport By Our Executive, Transfer To Hotel, Overnight Stay At Hotel In
                        Delhi.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Sightseeing Tour Of Old And New Delhi With Our Tour Guide, Visit India Gate,
                        Parliament House, President House, Raj Ghat, Humuyuns Tomb, Qutub Minar, Jama Masjid, Lotus
                        Temple, Enjoy Rickshaw Ride In Chandni Chowk, Overnight Stay At Hotel In Delhi.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Start Sightseeing Tour Of Jaipur With Our Tour Guide, Visit Amer Fort (Enjoy
                        Elephant Ride In Amer Fort), City Palace, Jantar Mantar, Hawa Mahal, Jal Mahal, In The Evening
                        Enjoy Dinner In Popular Local Restaurant, Overnight Stay At Hotel In Jaipur.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Drive To Ajmer, Visit Dargah Of Khwaja Muin-Ud-Din Chishti, Adhai Din Ka
                        Jhonpra, Anna Sagar Lake And Then Proceed To Pushkar, Arrive Pushkar, Check In Hotel, Overnight
                        Stay At Hotel In Pushkar.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Start Sightseeing Tour Of Pushkar, Visit Brahma Temple, Pushkar Lake, Drive To
                        Udaipur, Overnight Stay At Hotel In Udaipur.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Drive To Mount Abu, This Is The Only One Hill Station In Rajasthan, Check In
                        Hotel, Overnight Stay At Hotel In Mount Abu.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Start Sightseeing Tour Of Mount Abu, Visit Dilwara Temple, Nakki Lake, Tod
                        Rock, Drive To Jodhpur, Overnight Stay At Hotel In Jodhpur.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Start Sightseeing Tour Of Jodhpur With Tour Guide, Visit Majestic Mehrangarh
                        Fort, Jaswant Thada, Umaid Bhawan, Clock Tower And Explore Local Markets. Overnight Stay At
                        Hotel In Jodhpur.</p>
                    </div>
                  </div>
                </div>
