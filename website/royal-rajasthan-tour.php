    ...
    <section class="tour-listing-details tour-listing-details-right">
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/delhi-tours3.jpg"
              ...
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  ...
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhi-tours3.jpg"}, {"src": "assets/images/tours/agra-3.jpg"}, {"src": "assets/images/tours/udaipur-tour2.jpg"}, {"src": "assets/images/tours/udaipur-tour1.jpg"}, {"src": "assets/images/tours/jaipurtour1.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/udaipur-tour2.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhi-tours3.jpg"}, {"src": "assets/images/tours/agra-3.jpg"}, {"src": "assets/images/tours/udaipur-tour2.jpg"}, {"src": "assets/images/tours/udaipur-tour1.jpg"}, {"src": "assets/images/tours/jaipurtour1.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
              ...
              <div class="tour-listing-details__destination-right">
                ...
                <div class="tour-listing-details__destination-info wow animated fadeInUp" data-wow-delay="0.7s"
                  ...
                  <div class="tour-listing-details__destination-info-title">
                    ...
                    <h4 class="tour-listing-details__destination-info-bottom">DELHI - AGRA - JAIPUR - JODHPUR - UDAIPUR
                    </h4>
                  </div>
                </div>
                <!-- /.tour-listing-details__destination-info -->
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast proceed for sightseeing tour of Old Delhi visiting the Raj Ghat, the site where
                        Mahatma Gandhi was cremated; Jama Masjid - the largest mosque in India; and the Red Fort - once
                        the most opulent fort and palace of the Moghul Empire. In the afternoon take a sightseeing tour
                        of New Delhi visiting the Humayun's Tomb, the Qutub Minar. Drive along the ceremonial avenue -
                        Rajpath, past the imposing India Gate, Parliament House and the President's Residence .
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Agra and check in to hotel. Later visit the magnificent Taj Mahal -
                        one of the Seven Wonders of the World surely the most extravagant expression of love ever
                        created. 20,000 men labored for over 17 years to build this memorial to Shah Jahan's beloved
                        wife. Also visit the Red Fort - the rusty and majestic red-sandstone fort of Agra stands on the
                        banks of the river Yamuna.Overnight at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Jaipur en-route visit Fatehpur Sikri - built by the Mughal Emperor,
                        Akbar in honor of Saint Salim Chisti, who foretold the birth of 3 sons to Emperor Akbar, an
                        example of robust stability combined with originality. Each important edifice here represents a
                        type by itself. Notable among them is the Diwane Khas, Punch Mahal, The Tomb of Salim Chisti,
                        and the Buland Darwaza.After visit continue drive to Jaipur and check in to hotel. Overnight at
                        hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast excursion to Amber - the old capital of Jaipur rulers. Ride on the back of an
                        elephant from the foots of the hill upto the gates of the fortress. Afternoon sight seeing tour
                        of Jaipur including Maharaja's Museum and Jai Singh's Astronomical Observatory and Hawa Mahal.
                        Overnight at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Jodhpur and check in to hotel. After noon city tour includes the visit
                        of wonderful Mehrangarh Fort and Jaswant Thada (the royal Cenotaphs of Maharaja Jaswant Singh).
                        Overnight at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast drive to Udaipur en-route visit the Jain temples at Ranakpur built in white
                        marble. Its 29 halls spread over 40,000 sq.ft. and consisting of 1,444 pillars, not one of which
                        is alike in its carving at Ranakpur. After visit continue drive to Udaipur and check in to
                        hotel. Overnight at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast city tour of Udipur includes the visit of Palace Museum- made of granite and
                        marble with filigreed balconies, ornate windows and craftsmanship in glass. Each palace within
                        is an outstanding creation of art, Sahelion Ki Bari - a garden with fountains, once used for the
                        enjoyment of royal ladies. Bhartiya Lok Kala Mandal- a folk art museum, Jagdish Temple.
                        Afternoon enjoy boat ride on lake Pichola. Overnight at hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After breakfast departure transfer to Airport for flight to Delhi. Upon arrival transfer to
                        Airport for connect your International flight.</p>
                    </div>
                  </div>
                </div>
              </div>
