          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/delhitour2.jpg"
              ...
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  ...
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhitour2.jpg"}, {"src": "assets/images/tours/agratour2.jpg"}, {"src": "assets/images/tours/agra-4.jpg"}, {"src": "assets/images/tours/jaipur-tours3.jpg"}, {"src": "assets/images/tours/varanasi-tours-1.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <div class="tour-listing-details__destination-row row">
            <div class="col-xl-6 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
              <div class="tour-listing-details__destination-left">
                <h1 class="tour-listing-details__dastination-title">Imperial Golden Triangle Tour With Varanasi</h1>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p>First Day Of Imperial Golden Triangle Tour With Varanasi. You Will Be Welcomed By Our Company
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Drive Towards Jaipur, Upon Arrival Check Into Hotel, Overnight Stay At Jaipur
                        Hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Drive Towards Agra Via Fatehpur Sikri And Upon Arrival In Agra, Check Into
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Pick Up From Hotel At 06:30 A.M., Leave To Visit Taj Mahal At Sunrise Time Then Come Back To
                        Hotel For Having Healthy Breakfast. Later Visit Majestic Agra Fort, Mehtab Bagh And Beautiful
                        Itmad - Ud - Daulah (Baby Taj). Transfer To Agra Railway Station To Board Train For Varanasi,
                        Overnight Train Journey.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Arrive Varanasi In The Afternoon, You Will Welcomed And Pick By Our Executive On Railway
                        Station. Transfer To Your Pre Booked Hotel. Enjoy Evening "Aarti" Ceremony On The Ghats,
                        Overnight Stay At Varanasi Hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Having Breakfast, Start Sightseeing Tour Of Varanasi, Visit Beautiful Ancient Temples,
                        Aurangazebs Mosque And Enthralling Boat Ride In River Ganges. Overnight Stay At Varanasi Hotel.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Excursion Of Sarnath Which Is 10 Kms In East Of Varanasi And Popular As A
                        Buddhism Major Centre Of India.In The Afternoon Transfer To Varanasi Airport To Board Flight For
                        Delhi, Pick Up From Delhi Airport By Our Executive And Get Transfer To Hotel, Overnight Stay At
                        Delhi Hotel.</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Transfer To Delhi Airport As Per Your Flight Schedule To Board Flight For Onward Destination.
                        And Finish Your Delhi Agra Jaipur Varanasi Tour With Sweet Memories Of Tour.</p>
                    </div>
                  </div>
                </div>
              </div>
