          ...
          <div class="about-one__content">
            ...
            <div class="about-one__box">
              ...
              <h3 class="about-one__box__title">Safety First<br>
                Always</h3>
              <p class="about-one__box__text">Lorem Ipsum is simply dummy text of<br>
                the printing.</p>
            </div>
            <!-- /.about-box -->
            <div class="about-one__box">
              <div class="about-one__box__icon"><span class="icon-friendly-Guide"></span></div>
              <h3 class="about-one__box__title">Friendly<br>
                Guide</h3>
              <p class="about-one__box__text">Lorem Ipsum is simply dummy text of<br>
                the printing.</p>
            </div>
      ...
      <div
        ...
        <div class="item">
          <div class="testimonials-card centered-card">
            ...
            <div class="testimonials-card__quote">"Top-notch hospitality from start to end! Our entire Northern India
              itinerary was balanced and exciting. Not only did we get VIP treatment, but our driver Ashok was an
              absolute professional. We simply cannot recommend Touranzza enough. 10/10 experience!"</div>
          </div>
        </div>
      </div>
    </div>
