...
<section class="page-header">
    ...
    <!-- /.page-header__bg -->
    <div class="container">
        <h2 class="page-header__title wow animated fadeInLeft" data-wow-delay="0s" data-wow-duration="1500ms">Contact</h2>
...
<!-- About Four Start -->
    <div class="testimonial-one__bg trevlo-splax" style="background-image: url(assets/images/backgrounds/tetsimonial-1-bg.png);" data-para-options='{
        "orientation": "down",
        "scale": 1.5,
        "delay": ".3",
...
<section class="contact-page section-space-top">
            <div class="contact-page__info">
                        ...
                        <div class="col-lg-4 wow animated fadeInUp" data-wow-delay="0s" data-wow-duration="1500ms">
                            <div class="contact-page__info-box">
                                ...
                                <div class="contact-page__info-text-box">
                                    ...
                                    <a href="tel:+917830492929">
                                        <h4 class="contact-page__info-text contact-page__info-text-link">+91-7830492929</h4>
                                    </a>
                                    <a href="tel:+919837105911">
                                        <h4 class="contact-page__info-text contact-page__info-text-link">+91-9837105911</h4>
                                    </a>
                                </div>
                            ...
                            <div class="contact-page__info-box">
                                ...
                                <div class="contact-page__info-text-box">
                                    ...
                                    <a href="mailto:tajnirvanatours@gmail.com">
                                        <h4 class="contact-page__info-text contact-page__info-text-link">tajnirvanatours@gmail.com</h4>
                                    </a>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113579.7697542569!2d77.98001294999999!3d27.1761745!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39740d857c2f41d9%3A0x784aef38a9523b42!2sAgra%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1707820559541!5m2!1sen!2sin" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <!-- /.contact-page__info -->
            
            <!-- <div class="google-map ">
            <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3549.9810299835754!2d78.04740527544797!3d27.15688707650252!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjfCsDA5JzI0LjgiTiA3OMKwMDInNTkuOSJF!5e0!3m2!1sen!2sin!4v1707550686476!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div> -->
            <!-- /.google-map -->
        </section>
<!-- /.trevlo-progress -->
