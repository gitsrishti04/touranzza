    ...
    <section class="tour-listing-details tour-listing-details-right">
      <div class="tour-listing-details__top-carousel">
        ...
        "responsive":{
          ...
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/delhi-tours1.jpg"
              ...
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  ...
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhi-tours1.jpg"}, {"src": "assets/images/tours/delhi-tours3.jpg"}, {"src": "assets/images/tours/agra-2.jpg"}, {"src": "assets/images/tours/jaipur-tours1.jpg"}, {"src": "assets/images/tours/goa-tour.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <!-- /.tour-listing-details__top-carousel-item item -->
          <div class="tour-listing-details__top-carousel-item item">
            <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/goa-tour.jpg"
                alt="listing-details-carousel">
              <div class="tour-listing-details__top-carousel-overlay"> <a href="#"
                  class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup"
                  data-gallery-options='{"items": [{"src": "assets/images/tours/delhi-tours1.jpg"}, {"src": "assets/images/tours/delhi-tours3.jpg"}, {"src": "assets/images/tours/agra-2.jpg"}, {"src": "assets/images/tours/jaipur-tours1.jpg"}, {"src": "assets/images/tours/goa-tour.jpg"}], "gallery": {"enabled": true}, "type": "image"}'><span class="icon-plus"></span></a> </div>
          ...
          <div class="tour-listing-details__destination-row row">
            <div class="col-xl-6 wow animated fadeInLeft" data-wow-delay="0.1s" data-wow-duration="1500ms">
              <div class="tour-listing-details__destination-left">
                <h1 class="tour-listing-details__dastination-title">Imperial Golden Triangle Tour With Goa</h1>
              ...
              <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
                <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content">
                    <div class="inner">
                      <p>First Day Of Imperial Golden Triangle Tour With Goa. You Will Be Welcomed And Pick By Our Company
                        Representative On Arrival At Delhi Airport And Then You Will Be Transferred To Hotel. Overnight
                        Stay At Delhi Hotel.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Pick Up From Hotel As Per Your Flight Schedule, Transfer To Jaipur Airport To
                        Board Flight For Goa, Arrive Goa, Pick Up From Goa Airport, Transfer To Hotel, Overnight Stay At
                        Goa Hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast, Start North Goa Sightseeing - Visit Beautiful Beaches Of Goa Which Includes
                        Baga Beach, Meera Marg Beach And Calangute Beach. Also Visit Fort Augoda, Donal Paula And Old
                        Ancient Old Churches Of Goa. Enjoy Enthralling Boat Ride On Mandovi River, Overnight Stay At Goa
                        Hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>After Breakfast Start South Goa Sightseeing, Explore The Stunning Kolva Beach Followed By Visit
                        Of Mangeshi Temple And Santa Durga Temple. Overnight Stay At Goa Hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Day Free For Leisure Activites And Explore Local Market Of City Panjim. Overnight Stay At Goa
                        Hotel.</p>
                    </div>
                  </div>
                </div>
                <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                  ...
                  <div class="accrodion-content" style="display: none;">
                    <div class="inner">
                      <p>Transfer To Goa Airport To Board Flight For Mumbai Or Delhi With Sweet Memories Of Golden
                        Triangle Tour With Goa.</p>
                    </div>
                  </div>
                </div>
                <!-- <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
