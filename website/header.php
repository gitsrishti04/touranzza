      ...
      <div class="topbar-one__left">
        <ul class="topbar-one__info">
          <li class="topbar-one__info-item"> <span class="topbar-one__info-icon icon-phone-1"></span> <a
              href="tel:+919837105911" class="topbar-one__info-text">+91-9837105911</a></span> </li>
          <li class="topbar-one__info-item"> <span class="topbar-one__info-icon icon-phone-1"></span> <a
        ...
        <ul class="topbar-one__info topbar-one__info--right">
          <li class="topbar-one__info-item"> <span class="topbar-one__info-icon icon-clock-1"></span> <span
              class="topbar-one__info-text">Mon to Sat: 8.00 am - 7.00 pm</span> </li>
        </ul>
        <!-- /.topbar-one__info -->
      </div>
      <!-- /.topbar-one__left -->
        ...
        <nav class="main-header__nav main-menu">
          <ul class="main-menu__list">
            ...
            <li class="dropdown"> <a href="tour-packages.php">Tour Packages</a>
              <ul class="sub-menu">
                <li><a href="golden-triangle-tours.php">Imperial Golden Triangle Tours </a></li>
                <li><a href="same-day-tours.php">Private Day Experiences </a></li>
                <li><a href="rajasthan-tours.php">Royal Rajasthan Retreats </a></li>
              </ul>
            </li>
