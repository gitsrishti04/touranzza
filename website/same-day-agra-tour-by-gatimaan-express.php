    ...
    <div class="tour-listing-details__top-carousel">
      <div class="tour-listing-details__top-carousel-wrapper trevlo-owl__carousel owl-theme owl-carousel" data-owl-options='{
        ...
        <div class="tour-listing-details__top-carousel-item item">
          <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/train-trip1.jpg" alt="listing-details-carousel">
            <div class="tour-listing-details__top-carousel-overlay"> <a href="#" class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup" data-gallery-options='{
                        "items": [
                          {
                            "src": "assets/images/tours/train-trip1.jpg"
                          },
                          {
                            "src": "assets/images/tours/train-trip1.jpg"
                          }
        ...
        <!-- /.tour-listing-details__top-carousel-item item -->
        <div class="tour-listing-details__top-carousel-item item">
          <div class="tour-listing-details__top-carousel-image"> <img src="assets/images/tours/train-trip.jpg" alt="listing-details-carousel">
            <div class="tour-listing-details__top-carousel-overlay"> <a href="#" class="tour-listing-details__top-carousel-btn trevlo-btn trevlo-btn--base-three trevlo-image-popup" data-gallery-options='{
                        "items": [
                          {
                            "src": "assets/images/tours/train-trip.jpg"
                          },
                          {
                            "src": "assets/images/tours/train-trip.jpg"
                          }
            ...
            <div class="trevlo-accrodion tour-listing-details__faq" data-grp-name="tour-listing-details__faq">
              <div class="accrodion active wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                <div class="accrodion-title">
                  <h4><span>Wake up and get ready till 06:30 AM – Pick up from the hotel to the railway station</span></h4>
                </div>
                <div class="accrodion-content">
                  <div class="inner">
                    <p>In the morning, meet our staff at your preferred place (hotel /airplane terminal) and go to the railway station in Delhi to board the train. The train will take you to Agra station.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>The Gatimaan Express Train will depart from the Hazrat Nizamuddin railway station, Delhi, and will arrive in Agra at 09:50 am. This is a high-speed train and takes appx-two hours to reach the Agra city. Breakfast will be offered on the board of the train.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>On your arrival in Agra, the travel guide will meet you and transfer you to the TajMahal a wonderful mausoleum and the amazing attractions of Agra.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>Taj Mahal – Considered as one of the beautiful structures (fascination) in India and one of the seven wonders on the planet, TajMahal was built in 22 years (1632 – 1653) and it is said 20,000 workers worked day and night to complete this wonder. It was built by Shah-Jahan for his beautiful wife MumtazMahal. Being a marvelous white mausoleum, it has been combined with amazing greenery that makes your visit-worthy.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>After seeing Taj Mahal now it is time to enjoy some time at leisure and have a delicious lunch at Agra's popular place and post-lunch move to Agra Fort.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                ...
                <div class="accrodion-content" style="display: none;">
                  <div class="inner">
                    <p>It is generally known as the red fort in Agra and a perfect example of the excellence. The red sandstone Agra Fort was made by the great Mughal Emperor Akbar in the 15th century at the edge of the Yamuna river.</p>
                  </div>
                </div>
              </div>
              <div class="accrodion wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
